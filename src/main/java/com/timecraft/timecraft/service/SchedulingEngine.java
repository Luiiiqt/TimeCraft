 ...
 * - Teacher must be available at the timeslot (teacher_availability)
...
public class SchedulingEngine {
    ...
    private User resolveTeacher(Subject subject) {
        // Teacher is stored on the subject via subjects.teacher_id
        // This relationship is loaded lazily — access via subject's department
        // In a real impl, Subject would have a ManyToOne teacher field
        // For now this returns null and the calling code logs TEACHER_UNAVAILABLE
        return null;
    }
