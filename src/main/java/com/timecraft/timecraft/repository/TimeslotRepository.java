...
public interface TimeslotRepository extends JpaRepository<Timeslot, Long> {
    ...
    /**
     * Returns timeslots on a given day where the teacher is available
     * AND not already scheduled. Uses teacher ID (Long) to avoid
     * entity type mismatch between Teacher and User.
     */
